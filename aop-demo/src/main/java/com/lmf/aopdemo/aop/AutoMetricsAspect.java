...
//                StringUtils.hasLength(countedAnnotation.name()) ? countedAnnotation.name() : jp.getSignature().getName(), "counter");
...
//        String name = name(jp.getTarget().getClass(),
//                StringUtils.hasLength(meteredAnnotation.name()) ? meteredAnnotation.name() : jp.getSignature().getName(), "meter");
...
//    public void instrumentExceptionMetered(JoinPoint jp, Throwable ex,
//                                           ExceptionMetered exMeteredAnnotation) {
//        String name = name(jp.getTarget().getClass(),
//                StringUtils.hasLength(exMeteredAnnotation.name()) ? exMeteredAnnotation.name() : jp.getSignature().getName(), "meter", "exception");
//        Meter meter = exceptionMeters.computeIfAbsent(name, meterName ->
//                metricRegistry.meter(meterName));
//        meter.mark();
//    }
//
...
//                StringUtils.hasLength(timedAnnotation.name()) ? timedAnnotation.name() : pjp.getSignature().getName(), "timer");
